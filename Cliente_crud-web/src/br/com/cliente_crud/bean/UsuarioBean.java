...
public void consultarUsuario(){
	...
	usuarioService.consultar((Class<Usuario>) usuarioEntity.getClass(), getUsuario().getIdusuario());
}
...
public void listarUsuario() {
	...
	setUsuarios(usuarioService.listar((Class<Usuario>) usuarioEntity.getClass()));
